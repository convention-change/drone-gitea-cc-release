# This dockerfile uses extends image https://hub.docker.com/convention-change/drone-gitea-cc-release
# VERSION 1
...
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/drone-gitea-cc-release/main.go
...
ENTRYPOINT [ "/app/drone-gitea-cc-release" ]
# CMD ["/app/drone-gitea-cc-release", "--help"]